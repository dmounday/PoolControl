#include "Arduino.h"
// **********************************************************************************
// This code is used for a in-pool temperature monitor. The sensor and Moteino
// board (ATMEGA 328P) are contained in a water-proof enclosure that is partically
// submerged in water. A HTU21D sensor is used to sense the temperature and humitity
// inside the enclosure. The temperature will stablize to the water temperature.
...
//*********************************************************************************************
const uint16_t TRANSMITPERIOD {60000};  // read and send data every this many ms (WDT sleep)
//*********************************************************************************************
const uint16_t NODEID {790};        // MUST BE SET TO UNIQUE VALUE FOR EACH NODE !!!!!!!!!!!!!!
const uint16_t NETWORKID {200};
const uint8_t GATEWAYID {1};        // Node ID of Mighty hat on Pool Controller. Should typically be 1.
